...
export const servicesData: Service[] = [
  ...
  },
  {
    ...
    shortDescription: 'Análisis completo de vulnerabilidades y checklist de seguridad',
    description: 'Servicio integral de ciberseguridad que incluye análisis de vulnerabilidades, pentesting, auditoría de código, checklist de seguridad OWASP, escaneo automatizado, y plan de remediación. Protege tu infraestructura, aplicaciones y datos con las mejores prácticas de seguridad.',
    category: 'consulting',
    icon: 'fa-shield-alt',
    features: [
      ...
      'Análisis de dependencias y librerías vulnerables',
      'Checklist de seguridad personalizado',
      'Revisión de configuración de servidores',
      'Análisis de seguridad en APIs REST/GraphQL',
      'Testing de autenticación y autorización',
      'Evaluación de encriptación y cifrado',
      'Análisis de bases de datos y SQL injection',
      'XSS, CSRF y SSRF testing',
      'Seguridad en contenedores (Docker/K8s)',
      'Análisis de infraestructura cloud (AWS/Azure/GCP)',
      'Compliance assessment (PCI-DSS, GDPR, SOC2)',
      'Security headers y CORS validation',
      'Análisis de logs y detección de intrusiones',
      'Vulnerability scoring (CVSS)',
      'Informe ejecutivo con priorización',
      'Informe técnico detallado con evidencias',
      'Plan de remediación paso a paso',
      'Recomendaciones de hardening',
      'Security baseline documentado',
