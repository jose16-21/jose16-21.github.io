      ...
      <div className="max-w-7xl mx-auto px-8">
        <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr_1fr_1fr] gap-8 mb-8">
          <div>
            ...
            <p className="text-gray-light mb-4 font-light leading-relaxed">Consultor especializado en desarrollo tecnológico y transformación digital. Convirtiendo ideas innovadoras en soluciones tecnológicas exitosas.</p>
                ...
                {section.links.map((link, index) => (
                  <li key={index} className="mb-2">
                    {'icon' in link ? (
                      ...
                      <a href={link.href} className="text-gray-light no-underline transition-colors hover:text-secondary font-light">{link.text}</a>
                    )}
                  </li>
                ))}
              </ul>
        ...
        <div className="border-t border-primary-light pt-8 text-center">
          <p className="text-gray-light m-0 font-light">&copy; 2024 Juan José Hernández. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  );
